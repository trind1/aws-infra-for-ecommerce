...
# --- CloudWatch Agent log groups for API instances ---
...
# --- ALB, ASG/EC2 and RDS metric alarms ---
...
# --- Application log metric and alarm ---
...
resource "aws_cloudwatch_metric_alarm" "api_errors" {
  ...
  dimensions = {
    LogGroupName = aws_cloudwatch_log_group.api.name
  }
